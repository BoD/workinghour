...
// class Database actual constructor(databasePath: String) {
class OldDatabase constructor(databasePath: String) {
    ...
    fun insertLog(logType: LogType, dateTime: DateTime) {
        insertEventStatement.intParams(
            logType.dbRepresentation.toInt(),
    ...
    private fun logFromResultSet(resultSet: ResultSet): Log? {
        ...
        return Log(
            ...
            logType = LogType.fromDbRepresentation(resultSet.getLong(2)),
            dateTime = DateTime(
                Date(
